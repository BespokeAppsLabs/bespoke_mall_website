...
import { TrendingUp, DollarSign, Users, Building, Zap, Target } from "lucide-react"

const impactMetrics = [
  {
    icon: DollarSign,
    value: "R350K",
    label: "MVP Investment",
    description: "Initial development cost for the complete platform",
  },
  {
    icon: TrendingUp,
    value: "40%+",
  ...
  },
  {
    ...
    description: "From approval to live MVP deployment",
  },
]
...
const revenueStreams = [
  ...
  { name: "Content Services", description: "Professional ad design fees", icon: Building },
