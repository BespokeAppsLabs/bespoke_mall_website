    ...
    items: [
      {
        ...
        description: 'App banners, kiosk slots, video ads',
        icon: Target,
      },
      {
        name: 'Marketplace Fees',
        description: 'Commission on platform sales',
        icon: DollarSign,
      },
      {
        name: 'Content Services',
        description: 'Professional ad design and content creation fees',
        icon: Building,
      },
      {
        name: 'External Listings',
        description: 'Non-mall business listings',
        icon: Users,
      },
    ],
  },
