...
import { LayoutDashboard, Users, Smartphone, Monitor } from "lucide-react"

export const platformContent = {
    sectionHeader: {
        badge: "Platform Ecosystem",
        title: "Technology That Works Here",
        description: "Built for the realities of Lephalale. Offline-first kiosks, data-light mobile apps, and tenant tools that prove their worth."
    },
    modules: [
        {
            id: "customer",
            ...
            icon: Smartphone,
            description: "A data-sensitive, gamified mobile experience focusing on speed and value.",
            features: [
        ...
        },
        {
            ...
            icon: Monitor,
            description: "The 'Billboard' of the mall. High-visibility touchpoints that drive app acquisition.",
            features: [
        ...
        },
        {
            ...
            icon: Users,
            description: "Proof of ROI. Tools that show tenants exactly how digital ads drive physical sales.",
            features: [
